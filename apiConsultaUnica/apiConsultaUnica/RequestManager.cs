...
namespace ServicoUnica
{
    class RequestManager
    {
        ...
        public HttpWebResponse SendPOSTRequest(int n, string uri, string content, string login, string password, bool allowAutoRedirect)
        {
            HttpWebRequest request = GeneratePOSTRequest(uri, content, login, password, allowAutoRedirect);
            return GetResponse(n, request);
        }

        public HttpWebResponse SendGETRequest(int n, string uri, string login, string password, bool allowAutoRedirect)
        {
            HttpWebRequest request = GenerateGETRequest(uri, login, password, allowAutoRedirect);
            return GetResponse(n, request);
        }

        public HttpWebResponse SendRequest(int n, string uri, string content, string method, string login, string password, bool allowAutoRedirect)
        {
        ...
        internal HttpWebResponse GetResponse(int n, HttpWebRequest request)
        {
            if (request == null)
            {
